...
(function() {
  ...
  const translations = {
    zh: {
      ...
      'syrupFirmwareName': '小甜水',
      'gameFirmwareName': '游戏固件',
      'flashToolLink': '刷机工具',
      'multiFirmwareToolName': '多固件刷机工具',
      ...
      'mdcbookLead': 'MDC1200 通讯录：将 MDC ID 与呼号（英文/数字，最长 6 字符，如 BD1AHN）写入电台。固件收到匹配 ID 时，弹窗直接显示呼号；未匹配则仍显示 4 位十六进制 ID。',
      'mdcbookMeta': '存储：SPI 0x011000 独立 4KB 扇区（校准区之后）。最多 400 条，每条 10 字节（ID 2B + 呼号 8B，实际最长 6 字符），含 16 字节表头。不占用游戏固件电子书区 0x1E8000–0x200000，也不与 AUTH / Slot3 / 拼音 / 语音重叠。恢复出厂（OEM 擦除到 0xF000）不会清掉本区。注意：「备份配置」只备份 0x00A000 设置区，不含本通讯录；请用本页 CSV 导出/导入。',
      'mdcbookAddRow': '添加一行',
      'mdcbookExport': '导出 CSV',
      'mdcbookImport': '导入 CSV',
      'mdcbookColIndex': '#',
      'mdcbookColId': 'MDC ID',
      'mdcbookColIdSub': '十六进制 0001–FFFF',
      'mdcbookColName': '呼号',
      'mdcbookColNameSub': 'A–Z / 0–9，最长 6',
      'mdcbookCountFmt': '已填写 {used} / {max} 条',
      'mdcbookInvalidId': 'MDC ID 须为 0001–FFFF 的十六进制',
      'mdcbookInvalidName': '呼号仅限 A–Z 与 0–9，最长 6 字符',
      'mdcbookDupId': '存在重复 MDC ID：{id}',
      'mdcbookMaxRows': '已达上限 {max} 条',
      'mdcbookWriteEmpty': '请先填写至少一条有效记录',
      'mdcbookReadOk': '已从设备读取通讯录（{n} 条）',
      'mdcbookWriteOk': '已写入设备通讯录（{n} 条）',
      'mdcbookReadEmpty': '设备上暂无通讯录数据',
      'mdcbookExportEmpty': '表格为空，无可导出内容',
      'mdcbookImportOk': '已导入 {n} 条',
      'mdcbookImportSkip': '跳过 {n} 行无效数据',
