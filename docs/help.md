...
当设备变砖或需要恢复到原厂固件时，可以使用以下官方固件进行恢复：

## 原厂固件下载

| 设备型号 | 固件版本 | 文件大小 | 下载链接 |
|---------|---------|---------|---------|
| UV-K1(8) | v7.02.02 | 73.3 KB | [下载](../archive/quansheng.k1.stock.firmware.v7.02.02.bin) |
| UV-K1(8) | v7.03.01 | 69.6 KB | [下载](../archive/quansheng.k1.stock.firmware.v7.03.01.bin) |
| UV-K5(K6) | v7.00.11 | 70.0 KB | [下载](../archive/quansheng.k5v3.stock.firmware.v7.00.11.bin) |

## 恢复步骤

1. **进入刷机模式**：关机状态下，按住PTT键不放，同时插入USB连接电脑
2. **选择固件**：在网页"刷固件"标签页中，点击"选择文件"按钮，选择下载的原厂固件
3. **刷入固件**：点击"刷入固件"按钮，等待刷写完成
4. **重启设备**：刷写完成后，设备会自动重启

## 注意事项

- ⚠️ **确认设备型号**：UV-K1和UV-K5 V3的固件不通用，请选择正确的固件
- ⚠️ **备份校准数据**：恢复前建议先备份校准数据（如果设备还能正常开机）
- 刷入原厂固件后，设备的所有设置和信道数据会被清空
- 如需刷回本固件，请使用网页中的"远程获取"功能下载 `Dondji.fusion.bin`
